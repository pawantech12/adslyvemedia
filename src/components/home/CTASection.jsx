...
export default function CTA() {
  return (
    <section
      id="cta"
      className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 py-10 sm:py-12 lg:py-14"
    >
      {/* Background */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[24px] border border-white/10 bg-white/5 p-5 backdrop-blur-2xl sm:p-6 lg:rounded-[30px] lg:p-8"
        >
          {/* Top Border */}
          ...
          <div className="relative z-10 text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 rounded-full border border-cyan-400/20 bg-white/10 px-3 py-1 text-[11px] font-semibold text-cyan-300 backdrop-blur-xl sm:px-4 sm:py-1.5 sm:text-xs"
            >
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-cyan-500 via-blue-500 to-violet-500 text-white">
                <Handshake size={11} />
              </span>
              Let's Grow Together
            </motion.div>
            ...
            <h2 className="mx-auto mt-4 max-w-3xl text-2xl font-extrabold leading-tight tracking-tight text-white sm:text-3xl lg:text-4xl">
              Ready to{" "}
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm leading-6 text-slate-300 sm:text-[15px] sm:leading-7">
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-2.5">
              {[
                ...
                <div
                  key={item}
                  className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 backdrop-blur-xl"
                >
                  <div className="flex h-5 w-5 items-center justify-center rounded-full bg-gradient-to-r from-emerald-500 to-cyan-500 text-white">
            ...
            <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <motion.div
                ...
                className="flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-3 py-2.5 backdrop-blur-xl"
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-r from-emerald-500 via-cyan-500 to-blue-600 text-white shadow-lg">
                  <TrendingUp size={16} />
                </div>
            ...
            <div className="mt-6 border-t border-white/10 pt-4">
              <p className="mx-auto max-w-3xl text-[11px] leading-5 text-slate-400 sm:text-xs sm:leading-6">
